...
> Note: For gmkit, markdown syntax does not support converting spanned cells in tables, so a simple table is shown in the example.
...
| Name          | Damage | Range   |
|:--------------|:------:|:-------:|
| Shortsword    | 1d6    | Melee   |
| Longsword     | 1d8    | Melee   |
| Dagger        | 1d4    | 20/60   |
| Hand Crossbow | 1d6    | 30/120  |
| Longbow       | 1d8    | 150/600 |
| Greataxe      | 1d12   | Melee   |
